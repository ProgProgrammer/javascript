...
function watch_files()
{
    ...
    gulp.watch('./src/img/**', image_compress);
    gulp.watch('./**/*.php', browser_reload);
}

gulp.task('default', gulp.parallel(watch_files, css_style, scripts, pug_html, image_compress, sync));